                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Search Appointment History by Appointment Email</h2>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Result with "<?php echo $sdata;?>" keyword </h4>
...
$sql="SELECT * from tblappointment where AppointmentNumber like '$sdata%' || Name like '$sdata%' || Email like '$sdata%'";
